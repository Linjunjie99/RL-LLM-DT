...
parser.add_argument('--observation_space', type=int, default=(20),
...
def main():
    ...
    agent = init_components(args, unknown_args)
        ...
        if len(mem_pool) >= args.batch_size:
            ...
            if freq%args.ckpt_save_freq == 0:
                if args.ckpt_save_type == 'checkpoint':
                    ...
                    with open(args.ckpt_path / 'weight{}.ckpt'.format(freq//10), 'wb') as f:
