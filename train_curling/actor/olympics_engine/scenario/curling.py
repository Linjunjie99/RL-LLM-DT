    ...
    def step(self, actions_list):
        ...
        if not done:
            ...
            if round_end:
                ...
                if(self.flag == 0):
                    min_dist = self.cal_game_point()

                    reward = np.array([self.purple_game_point-self.green_game_point,self.green_game_point-self.purple_game_point])

                    temp = reward - self.last_reward
            ...
            if self.game_round == 1:
                ...
                return next_obs, reward, False, 'game1 ends, switch position', min_dist
            else:
                raise NotImplementedError
        ...
        return obs_next, reward, done, '', min_dist
