...
class OlympicsCurling(Game):
    ...
    def step(self, joint_action):
        ...
        all_observations, reward, done, info_after, min_dist = self.env_core.step(joint_action_decode)
        ...
        trainable_team = -1
        if self.all_observes[0]['release'] == True:
            trainable_team = -1
        else:
            trainable_team = self.env_core.current_team
        return self.all_observes, reward, self.done, info_before, info_after,trainable_team, min_dist
